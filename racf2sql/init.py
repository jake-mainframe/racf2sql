...
def init_gralias(c):
    c.execute('CREATE TABLE gralias (name TEXT, class_name TEXT, iplook INTEGER)')
...
def init_grcsfk(c):
    c.execute('CREATE TABLE grcsfk (name TEXT, class_name TEXT, label TEXT)')

def init_grcsfc(c):
    c.execute('CREATE TABLE grcsfc (name TEXT, class_name TEXT, label TEXT)')
...
def init_grmpf(c):
    c.execute('CREATE TABLE grmpf (name TEXT, class_name TEXT, pol_factor TEXT)')
