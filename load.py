...
def process_grtmec(l, c):
    v = (
        l[5:251],     #GRTMEC_NAME        General resource name as taken from the profile name.
        l[252:260],   #GRTMEC_CLASS_NAME  Name of the class to which the general resource belongs.
        l[261:507],   #GRTMEC_CHILD       Child role.
    )
...
def process_grtmee(l, c):
    v = (
        l[5:251],     #GRTMEE_NAME        General resource name as taken from the profile name.
        l[252:260],   #GRTMEE_CLASS_NAME  Name of the class to which the general resource belongs.
        l[261:507],   #GRTMEE_ROLE_NAME   Role profile name.
        l[508:516],   #GRTMEE_ACCESS_AUTH Access permission to this resource as defined by the role.
        l[517:525],   #GRTMEE_COND_CLASS  Class name for conditional access.
        l[526:772],   #GRTMEE_COND_PROF   Resource profile for conditional access.
    )
...
def process_grcsfk(l, c):
    v = (
        l[5:251],     #GRCSFK_NAME        General resource name as taken from the profile name.
        l[252:260],   #GRCSFK_CLASS_NAME  Name of the class to which the general resource profile belongs.
        l[261:325],   #GRCSFK_LABEL       ICSF key label of a public key that can be used to export this symmetric key.
    )
...
def process_grcsfc(l, c):
    v = (
        l[5:251],     #GRCSFC_NAME        General resource name as taken from the profile name.
        l[252:260],   #GRCSFC_CLASS_NAME  Name of the class to which the general resource profile belongs.
        l[261:358],   #GRCSFC_LABEL       Certificate identifier of a public key that can be used to export this symmetric key.
    )
